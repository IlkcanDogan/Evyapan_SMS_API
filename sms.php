...
function SendSMS($content, $phoneNumber)
{
    ...
    curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode(["type" => 1, "sendingType" => 0, "title" => "FIRMA_ADI", "content" => $content, "number" => $phoneNumber, "encoding" => 0, "sender" => "FIRMA_ADI", "periodicSettings" => null, "sendingDate" => null, "pushSettings" => null]));
